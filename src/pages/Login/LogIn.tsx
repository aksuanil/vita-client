...
export default function LogIn({ showPopup }: Props) {
    ...
    async function handleSubmit(event: any) {
        ...
        const response = await loginWithEmailAndPassword(object);
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    <form onSubmit={handleSubmit} className="lg:px-10 sm:px-6 px-2">
                                        ...
                                        <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                                            Dont have account?{" "}
                                            <NavLink to="/signup" className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
                                                {" "}
                                                Sign up here
                                            </NavLink>
                                        </p>
                                        ...
                                        <div className="mt-8">
                                            <button type='submit' className="focus:ring-2 focus:ring-offset-2 focus:ring-themeGreenLight text-sm font-semibold leading-none text-white focus:outline-none bg-themeGreenDark border rounded hover:bg-themeGreen py-4 w-full">
                                                Login to my account
                                            </button>
                                        </div>
                                    </form>
